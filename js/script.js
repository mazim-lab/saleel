document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contactForm) {
        ...
        const buildMailto = (formData) => {
            ...
            const subject = encodeURIComponent(`Saleel website inquiry from ${name}`);
            ...
            return `mailto:info@saleel.ca?subject=${subject}&body=${body}`;
        };
        ...
        contactForm.addEventListener('submit', async (event) => {
            ...
            try {
                ...
                if (!response.ok) {
                    throw new Error('Form send failed');
                }
